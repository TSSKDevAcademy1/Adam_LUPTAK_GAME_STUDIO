...
public class Miny extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			for (int j = 0; j < field.getColumnCount(); j++) {
				...
				if ("1".equals(mark)) {
					if (field.getState() == GameState.PLAYING) {
						out.print("<a href=\"http://localhost:8080/games/hello?x=" + i + "&y=" + j + "&mark=" + mark
								+ "\">");
					}
				} else {
					if (field.getState() == GameState.PLAYING) {
						out.print("<a href=\"http://localhost:8080/games/hello?x=" + i + "&y=" + j + "\">");
					}
				}
		...
		out.print(
				"Contact information: <a href=\"mailto:adamluptakosice@gmail.com\">adamluptakosice@gmail.com</a>.</p>");
		out.print("</footer>");
		out.print("</body>");
		out.print("</html>");
	}
